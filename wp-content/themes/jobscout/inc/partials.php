...
function jobscout_get_banner_sub_title(){
    $banner_subtitle = get_theme_mod( 'banner_subtitle', __( 'The secret behind our company is simple: to always put ourselves in the other person\'s shoes-employee, guest or customer. This allows us to see the world through their eyes. anticipate their needs and better understand their feelings', 'jobscout' ) );
...
function jobscout_ed_wp_link(){
     printf( esc_html__( ' ', 'jobscout' ), '<a class="wp-link" href="'. esc_url( __( 'https://wordpress.org/', 'jobscout' ) ) .'" target="_blank">WordPress</a>.' );
}
endif;